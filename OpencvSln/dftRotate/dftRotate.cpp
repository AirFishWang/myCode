...
int main(int argc, char **argv)
{
    ...
    const char* filename = "jipiao0002.jpg";
    ...
    threshold(magImg, magImg, GRAY_THRESH, 255, CV_THRESH_BINARY);   //大于GRAY_THRESH 则设置为255
